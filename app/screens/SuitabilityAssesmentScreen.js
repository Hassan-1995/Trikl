...
const questionnaire = [
    { question: 'Please select your age bracket', keyId: 1,
        answers: [
    ...
    { question: 'Which explains your Health Scenario the best', keyId: 2,
        answers: [
    ...
    { question: 'How often do you exercise?', keyId: 3,
        answers: [
            { key: '1', option: "Daily" },
    ...
    { question: 'What is your preferred type of exercise?', keyId: 4,
        answers: [
    ...
    { question: 'How would you rate your diet?', keyId: 5,
        answers: [
    ...
    { question: 'How many hours of sleep do you get on average?', keyId: 6,
        answers: [
    ...
    { question: 'What is your stress level?', keyId: 7,
        answers: [
    ...
    { question: 'How often do you visit a doctor for a check-up?', keyId: 8,
        answers: [
    ...
    { question: 'Do you smoke?', keyId: 9,
        answers: [
            { key: '1', option: "Yes" },
            { key: '2', option: "No" },
        ]
    },
    { question: 'Do you consume alcohol?', keyId: 10,
        answers: [
